package com.mirea.pershinadv.timeservice;
...
import com.mirea.pershinadv.timeservice.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetTimeTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String timeResult) {
            ...
            binding.TextViewDate.setText(devided_res[1]);
            binding.textViewTime.setText(devided_res[2]);
        }
    }
}